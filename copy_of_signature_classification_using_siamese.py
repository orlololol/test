...
if __name__ == "__main__":
    ...
    # test_img = '/content/drive/My Drive/Handwriting_analysis'

    # infer_img =  Sign_Data(test_img,test_csv,transform=transforms.Compose([transforms.Resize((100,100)),transforms.ToTensor()]))

    # infer_dataloader = DataLoader(infer_img,num_workers=8,batch_size=1,shuffle=True)
